...
RSpec.describe 'Movies show page' do
  before(:each) do
    ...
    @actor_1 = @studio_1.actors.create!(name: "Harrison Ford", age: 78)
    @actor_2 = @studio_1.actors.create!(name: "Natalie Portman", age: 40)
    @actor_2 = @studio_1.actors.create!(name: "Adam Driver", age: 35)
  end
